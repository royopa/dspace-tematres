...
/**
 *    # URL do servidor de serviços
 *    tematres.url = http://[dspace.url]/a/tematres/vocab/services.php
 *    
 *    IMPORTANTE: 
 *    A classe foi desenvolvida especificamente para ler os dados informados pelo Tematres. 
 *    As informações apresentadas pelo Tematres ou qualquer outro web service deverá, obrigatoriamente, 
 *    apresentar o número de ocorrências retornadas antes da leitura das tags contendo informações 
 *    do resultado da busca. 
 *    No caso do Tematres, essa informação está definida pela tag cant_result, que foi alterada 
 *    para ser apresentada no início das tags.
 *
 */
public abstract class TematresProtocol implements ChoiceAuthority
{
        ...
        extends DefaultHandler
    {
            ...
            throws SAXException
        {
            ...
            {
                // error message
                log.warn("Tematres response error message: " + textValue.trim());
            }
        }
